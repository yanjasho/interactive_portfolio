        ...
        return (
            <Jumbotron style={{backgroundImage: "linear-gradient(#bfbfbf, #c6ffb3, #c6ffb3, #E6E6FA)", padding:200}}>
                ...
                <ul className="list-group" style={{backgroundColor:"#f2e6d9"}}>Here are some cool things I've done:
                    ...
                    <li className="list-group-item">Node and Mysql ordering app <a href="https://github.com/yanjasho/bamazon" target="_blank" rel="noopener noreferrer"> &rArr; See the code</a> Tech: Node.js, MySQL, npm packages (particularly MySQL and Inquirer), inputs validations. </li>
